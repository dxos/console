...
if ('serviceWorker' in navigator) {
  window.addEventListener('load', () => {
    // TODO(burdon): Remove "dxn:" from path so that escape characters are not required.
    // main.js?56d7:23 SW registration failed: TypeError: Failed to register a ServiceWorker:
    // The provided scope ('https://apollo1.kube.moon.dxos.network/app/dxn%3A%2F%2Fdxos%2Fapplication%2Fconsole%40alpha/')
    // or scriptURL ('https://apollo1.kube.moon.dxos.network/app/dxn%3A%2F%2Fdxos%2Fapplication%2Fconsole%40alpha/service_worker.js')
